...
class GameMenu(App):
        ...
        def build(self):
                ...
                background_start_game = (Image(allow_stretch=True, keep_ratio=False, size=(self.Ratio*self.WindowHight,self.Ratio*self.WindowWidth),source='Images\StartGame.jpg'))
                new_game_button = (Button(text="New Game", font_size=Ratio*34, on_press=self.create_coach, background_color=[45, 100, 0, 0],pos=(self.Ratio * 116, self.Ratio * 476), size=(self.Ratio * 300, self.Ratio * 48)))
                continue_button = (Button(text="Continue", font_size=self.Ratio * 34, on_press=self.continue_the_game,background_color=[45, 100, 0, 0], pos=(self.Ratio * 63, self.Ratio * 416),size=(self.Ratio * 300, self.Ratio * 48)))
                settings_button = (Button(text="Settings", font_size=Ratio*34, on_press=self.game_settings, background_color=[45, 100, 0, 0],pos=(self.Ratio * 18, self.Ratio * 356), size=(self.Ratio * 300, self.Ratio * 48)))
                quit_button = (Button(text="Quit", font_size=self.Ratio*34, background_color=[45, 100, 0, 0], on_press=self.exit_the_game,pos=(self.Ratio * -52, self.Ratio * 296), size=(self.Ratio * 300, self.Ratio * 48)))

                self.game.add_widget(background_start_game)
        ...
        def create_coach(self,instance):
                background_coach = (Image(allow_stretch=True,keep_ratio=False,size =(self.WindowHight,self.WindowWidth),source='Images\Coach.png'))
                self.game.add_widget(background_coach)
                dropdown = DropDown()
                ...
                save_information_button = Button(text="Save",font_size=self.Ratio*34,on_press=self.save_coach,background_color=[1,1,1,1],pos=(self.Ratio*(self.WindowHight-Ratio*236),self.Ratio*0),size=(self.Ratio*236,self.Ratio*50)) 
                league_button = Button(text="League",font_size=self.Ratio*34,on_press=self.enter_league,pos=(self.Ratio*(self.WindowHight-self.Ratio*556),self.Ratio*(self.WindowWidth-self.Ratio*254)),size=(self.Ratio*250,self.Ratio*48))
                ...
                self.game.add_widget(Button(text="Continue",font_size=self.Ratio*34,on_press=self.main_menu,background_color=[1,1,1,1],pos=(self.Ratio*(self.WindowHight-self.Ratio*472),self.Ratio*0),size=(self.Ratio*236,self.Ratio*50)))

                return self.game


        def enter_league(self,instance):
                epl_button = Button(text="EPL",font_size=self.Ratio*34,on_press=self.enter_team,pos=(self.Ratio*(self.WindowHight-self.Ratio*556),self.Ratio*(self.WindowWidth-self.Ratio*254)),size=(self.Ratio*250,self.Ratio*48))
        ...
        def enter_team(self,instance):
                ...
                if self.team_button.text=='ARSENAL':
                       self.main_menu_background.source='Images\MainMenuArsenal.jpg'
                elif self.team_button.text=='CHELSEA':
                        self.main_menu_background.source='Images\MainMenuChelsea.jpg'
                elif self.team_button.text=='LIVERPOOL':
                       self.main_menu_background.source='Images\MainMenuLiverpool.jpg'
                elif self.team_button.text=='MANCHESTER CITY':
                        self.main_menu_background.source='Images\MainMenuManchester City.jpg'
        ...
        def main_menu(self,instance):
                ...
                mail_button = (Button(text="Mail",font_size=self.Ratio*34,on_press=self.mail,background_color=[1,1,1,1],pos=(self.Ratio*0,self.Ratio*(self.WindowWidth-Ratio*195)),size=(self.Ratio*236,self.Ratio*105)))
                ...
                coach_button = (Button(text="Coach",font_size=self.Ratio*34,on_press=self.coach,background_color=[1,1,1,1],pos=(self.Ratio*0,self.Ratio*(self.WindowWidth-Ratio*510)),size=(self.Ratio*236,self.Ratio*105)))
                squad_button = (Button(text="Squad",font_sizeself.=Ratio*34,on_press=self.squad,background_color=[1,1,1,1],pos=(self.Ratio*0,self.Ratio*(self.WindowWidth-Ratio*615)),size=(self.Ratio*236,self.Ratio*105)))
                ...
                match_button = (Button(text="Match",font_size=Ratio*34,on_press=self.match,background_color=[1,1,1,1],pos=(self.Ratio*(self.WindowHight-Ratio*236),self.Ratio*0),size=(self.Ratio*236,self.Ratio*50)))
                ...
                self.game.add_widget(Button(background_normal='Images\Field.jpg',on_press=self.placement,pos=(self.Ratio*(self.WindowHight-self.Ratio*1044),self.Ratio*(self.WindowWidth-self.Ratio*670)),size=(self.Ratio*768,self.Ratio*580)))
